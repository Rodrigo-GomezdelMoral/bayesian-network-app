...
from utils.param_mapping import map_parameters
...
data = pd.read_csv("utils/ordered_preprocessed_data.csv")
...
trained_network_file = "utils/net/bayesian_network.html"
